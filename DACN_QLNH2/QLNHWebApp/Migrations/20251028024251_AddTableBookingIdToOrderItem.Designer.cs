...
namespace QLNHWebApp.Migrations
{
    ...
    [Migration("20251028024251_AddTableBookingIdToOrderItem")]
    partial class AddTableBookingIdToOrderItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QLNHWebApp.Models.Table", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("QLNHWebApp.Models.TableBooking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("QLNHWebApp.Models.Order", b =>
                {
                    b.HasOne("QLNHWebApp.Models.Table", "Table")
                        .WithMany()
            ...
            modelBuilder.Entity("QLNHWebApp.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("QLNHWebApp.Models.TableBooking", "TableBooking")
                        .WithMany("OrderItems")
